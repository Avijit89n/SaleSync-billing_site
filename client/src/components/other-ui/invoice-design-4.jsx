      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.invoiceTitleBlock}>
          <Text style={styles.invoiceLabel}>
            Revenue Invoice / Voucher
          </Text>

          <Text style={styles.invoiceNumberText}>
            Invoice No: #{invoiceNumberSequence}
          </Text>
        </View>
        ...
        <View style={styles.billingGrid}>
          <View style={styles.billingCard}>
            ...
            {selectedCustomer?.workingPhone && (
              <Text style={styles.profileSecondaryText}>
                Contact: {selectedCustomer.workingPhone}
              </Text>
            )}
        ...
        >
          <Text style={styles.footerDisclaimerText}>
            E.&O.E. Please match items against
            physically signed delivery challans.
          </Text>
