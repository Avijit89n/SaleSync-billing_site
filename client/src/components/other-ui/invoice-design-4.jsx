...
const styles = StyleSheet.create({
  ...
  tableDataRow: { flexDirection: "row", borderBottomWidth: 1, borderBottomColor: "#e7e5e4", paddingVertical: 8, paddingHorizontal: 6, alignItems: "center" },
...
export default function InvoiceDesign4({ companyInfo, companyLogo, companySignature, invoiceNumberSequence, isPaid, issueDate, dueDate, selectedCustomer, itemData = [], subtotal = 0, totalDiscount = 0, taxRate = 0, taxedAmount = 0, grandTotal = 0, notes, terms, paymentStatus, paidAmount = 0, balanceAmount, payments = [], isPreview = true }) {
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.metaDataGrid}>
          <View style={styles.metaColumn}>
            <Text style={styles.metaItemText}><Text style={styles.metaLabel}>Invoice No: </Text>#{invoiceNumberSequence}</Text>
            <Text style={styles.metaItemText}><Text style={styles.metaLabel}>Issue Date: </Text>{formatDate(issueDate)}</Text>
            <Text style={styles.metaItemText}><Text style={styles.metaLabel}>Due Date: </Text>{formatDate(dueDate)}</Text>
          </View>
        ...
        <View style={styles.billingGrid}>
          <View style={styles.billingCard}>
            ...
            {selectedCustomer?.workingPhone && <Text style={styles.profileSecondaryText}>Contact: {selectedCustomer.workingPhone}</Text>}
        ...
        <View fixed style={styles.globalPageFooter}>
          <Text style={styles.footerDisclaimerText}>E.&O.E. Please match items against physically signed delivery challans.</Text>
